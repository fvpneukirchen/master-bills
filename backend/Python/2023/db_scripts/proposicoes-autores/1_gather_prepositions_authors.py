...
with open('output/lista_preposicoes_autores.json', 'r', encoding='utf-8-sig') as openfile:
...
async def main():
    ...
    with open("output/preposicoes_autores_limpos.json", "w", encoding='utf8') as outfile:
