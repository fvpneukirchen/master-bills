...
async def main():
    ...
    for processing in json_object:
        urls.append(["https://dadosabertos.camara.leg.br/api/v2/proposicoes/{tramit_id}/autores", processing])
    ...
    with open("../generate_mass/preps_autores.json", "w", encoding='utf8') as outfile:
